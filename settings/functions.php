...
{
    $query = "INSERT INTO $tName ($columnName) VALUES ($values)";
    return (bool) $conn->prepare($query);
...
function getData(string $tName, $id = null)
{
    if ($id == null) {
...
function url_slug($str, $options = array())
{
    ...
    $char_map = array(
        ...
        // Turkish
        'Ş' => 'S', 'İ' => 'I', 'Ç' => 'C', 'Ü' => 'U', 'Ö' => 'O', 'Ğ' => 'G', 'Ə' => 'A',
        'ş' => 's', 'ı' => 'i', 'ç' => 'c', 'ü' => 'u', 'ö' => 'o', 'ğ' => 'g', 'ə' => 'a',
